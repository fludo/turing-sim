 ...
 * @author Ludovic Favre <ludovic.favre@epfl.ch>
 */
public class Sub implements TInstruction {
    ...
    public Sub(String[] input, ITypes[] types) throws Exception {
    ...
    public boolean accepts() {
        //System.out.println("Sub state is : "+this.tm_.currentState().label());
    ...
    public String output() {
        String res = TinyLangUtils.removeLeadindZeros(this.tm_.tapeString().replaceAll("#", "").replaceAll("S", "").replaceAll("X", "").replaceAll("\u2423", ""));
        if (res.equals("")) {
            //we have removed to many 0's...
            res = "0";
        }
        return res;
    }
